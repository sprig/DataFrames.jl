...
Base.reduce(::typeof(vcat),
    dfs::Union{SentinelArrays.ChainedVector{T,A} where {T::AbstractDataFrame, A<:AbstractVector{T}},
        SentinelArrays.ChainedVector{T,A} where {T::DataFrame, A<:AbstractVector{T}},
        SentinelArrays.ChainedVector{T,A} where {T::SubDataFrame, A<:AbstractVector{T}},
        SentinelArrays.ChainedVector{T,A} where {T::Union{DataFrame, SubDataFrame}, A<:AbstractVector{T}}};
    cols::Union{Symbol,AbstractVector{Symbol},
        AbstractVector{<:AbstractString}}=:setequal,
    source::Union{Nothing,SymbolOrString,
        Pair{<:SymbolOrString,<:AbstractVector}}=nothing,
